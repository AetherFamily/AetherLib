 ...
 * The intention is that this class will be used in builder form
 *
 * @author SamJakob (Original)
 * @author Magnetite (Updated)
 * @version 2.0.0
 * @see ItemStack
 */
public class ItemBuilder {
    ...
    public ItemBuilder skullBase64(String base64) {
        if (!Material.PLAYER_HEAD.equals(stack.getType())) {
            return this;
        }
